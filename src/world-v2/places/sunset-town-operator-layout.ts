 ...
 * The performance stage is modeled separately as a west/seaward relative
 * element inside the large Kiss Bridge arc.
 */
export const SUNSET_TOWN_OPERATOR_PLAN: Readonly<Record<string, RelativePlanPoint>> = {
  ...
  'kiss-seating': { x: 0.8392857142857143, y: 0.7783018867924528 },
